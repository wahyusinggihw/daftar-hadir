...
<script type="text/javascript" src="<?= base_url('assets/front_end/js/signature.js') ?>"></script>
<script type="text/javascript" src="<?= base_url('assets/front_end/js/form-absensi-2.js') ?>"></script>
<script>
