...
<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #007bff;">
    ...
    <ul class="navbar-nav" style="padding-left: 10px;">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link" href="#" onclick="return false;" style="cursor: default; color:white" role="button"><?= strtoupper(session()->get('role')) ?></a>
        </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto" style="padding-right: 10px;">
        ...
        <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle" style="color:white;"><?= session('username') ?></a>
