        ...
        <div class="card-body">
            <div class="col">
                ...
                <div class="col d-flex justify-content-center">
                    <div class="row mb-2">
                        <a href="whatsapp://send?text=<?= urlencode('Check out this meeting information: ' . base_url('rapat/informasi/' . $data['kode_rapat'])) ?>" role="bt" class="btn btn-outline-info" target="_blank"><i class="fa-brands fa-whatsapp fa-xl"></i></a>
                    </div>
